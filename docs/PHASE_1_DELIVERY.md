...
> **Status (historical):** All 23 tasks complete as of the original Phase 1
> delivery. The numbers and structure in this document reflect the **state
> at end of Phase 1** (commit `af89c48`-era; test counts and tree shape have
> evolved). For the **current** tree, test counts, and architecture see:
>
> - [`README.md`](../README.md) — current public overview
> - [`docs/superpowers/specs/2026-08-04-docs-expansion-design.md`](superpowers/specs/2026-08-04-docs-expansion-design.md) — the active docs expansion plan
...
│   │   └── model.py                # HyMo 32-layer stack (placeholder, registered)
│   ├── training/
│   │   ├── __init__.py                 # Public re-exports
...
```
   ...
   │   hymo) │   │   fsdp, ckpt,  │  │  sharding) │  │  run_all)  │
   │              │   │   validation,  │  │            │  │            │
   │              │   │   trainer)     │  │            │  │            │
   └──────┬───────┘   └────────┬───────┘  └─────┬──────┘  └─────┬──────┘
          │                    │                │               │
...
| `models/model.py` | `HyMo.forward` (32-layer loop), `forward_with_hidden`. | ✅ real |
